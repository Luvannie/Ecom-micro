...
public class OrderEventConsumer {
    ...
    public void handleConfirmed(OrderConfirmedEvent event) {
        ...
        try {
            ...
            log.error("Failed to process ORDER_CONFIRMED for orderId={}: {}", event.orderId(), e.getMessage());
            throw e;
        }
    }
    ...
    public void handleCancelled(OrderCancelledEvent event) {
        ...
        try {
            ...
            log.error("Failed to process ORDER_CANCELLED for orderId={}: {}", event.orderId(), e.getMessage());
            throw e;
        }
    }
